package com.xdlteam.pike.widget;
...
public class VideoRecoderProgress extends View {
    ...
    public VideoRecoderProgress(Context context) {
        super(context);
        init(context);
    }
    ...
    public VideoRecoderProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VideoRecoderProgress(Context context, AttributeSet attrs, int defStyleAttr) {
